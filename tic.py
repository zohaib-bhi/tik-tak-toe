...
def play():
	...
	menu.title("Tic Tak Toe")
	wpc = partial(withpc, menu)
	wpl = partial(withplayer, menu)

	head = Button(menu, text="Welcome to my game",
				activeforeground='black',
				activebackground="yellow", bg="blue",
				fg="yellow", width=500, font='impact', bd=5)
	...
	B2 = Button(menu, text="Multi Player", command=wpl, activeforeground='red',
				activebackground="black", bg="blue", fg="yellow",
				width=500, font='impact', bd=5)
